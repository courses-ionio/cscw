...
Μέσω του μαθήματος Κινητά και κοινωνικά μέσα, ως φοιτητής του ιονίου πανεπιστημίου στο τμήμα πληροφορικής ευελπιστώ να εξοικειωθώ στα παρακάτω:
 ...
 - Στο να εξοικειωθώ σε ένα αντικείμενο που πολύ πιθανότατα να ακολουθήσω στο μέλλον, το οποίο είναι το front-end web developing. Πιο συγκεκριμένα, να αναπτύξω τις γνώσεις και τις δεξιότητές μου στις πολύ γνωστές και βασικές γλώσσες προγραμματισμού HTML-CSS-JAVASCRIPT.
