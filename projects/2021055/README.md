...
### Mushroom counter
Η πρώτη προσθήκη στο παιχνιδί είναι ένας μετρητής ο οποίος θα μετράει πόσα μανητάρια συλλέγει ο παίκτης. Για την δημιουργία του, αρχικά, έφτιαξα μια συνάρτηση η οποία έλεγχεί αν ο παικτής έχει συλλέξει κάποιο μανητάρι. Στην συνέχεια, μέσα στην λούπα engine.onUpdate = (), η οποία είναι η βασική λούπα του παιχνιδιού και μέσα σε αυτή τρέχουν όλα τα αντικείμενα και οι συναρτήσεις, έφτιαξα μια for, ή οποία καλεί την συνάρτηση mushrooms για να ελένξει άν έχει πιαστεί κάποιο μανητάρι, άν η συνηθήκη είναι `true` τότε αυξάνει τον μετρητή numberOfGrabbedMushrooms κατα ένα. Για την απεικόνηση του μετρητή στο παιχνίδι, χρησομοποιοείται η εντολή `scr`.
