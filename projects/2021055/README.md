...
Το project katana είναι ένα platform παιχνιδί. Το παιχνίδι ξεκινά με έναν χαρακτήρα ο οποίος κρατάει ένα σπαθί κατάνα, κατά την διάρκεια του παιχνιδιού ο παίκτης πρέπει να διαπεράσει κάποια εμπόδια, με σκοπό να φτάσει στον τερματισμό και να κόψει την σημαία που υπάρχει εκεί. Στην συνέχεια, χρησιμοποιώ την εντολή `table` της γλώσσας html γι να δημιουργήσω τον πίνακα. Με την εντολή `thead` εισάγω όλες τις απαιρέτητες επικεφαλίδες(ΩΡΑ,ΗΜΕΡΑ κ.α). Για την προσθήκη περιεχομένου στον πίνακα, χρησιμοποιείται η εντολή `tbody`
