...
#### Τα παρακάτω κριτήρια επιλέχθηκαν με βάση τις δυνατότητες που παρέχει η πλειοψηφία των fantasy consoles που επέλεξα προσωπικά για μελέτη και με το κατά πόσο αυτά τα εργαλεία είναι χρήσιμα στη ανάπτυξη ενός παιχνιδιού.
 ### Sound Editor
 O sound editor δίνει την δυνατότητα στον χρήστη να δημιούργησει την δική του μουσική. Ανάλογα με το όργανο που παρέχει το κάθε παιχνίδι για την σύνθεση μουσικής μελοδίας, ο χρήστης μπορεί να φτιάξει όσα μουσικά κομμάτια επιθυμεί για κάθε λειτουργία του παιχνιδιού, όπως για την κίνηση του χαρακτήρα και για το background του παιχνιδιού.
 
 ### Map Editor
 Ο map editor επιτρέπει στον χρήστη να σχεδιάσει εξ ολοκλήρου τον χάρτη του παιχνιδιού του. Πιο συγκεκριμένα, υπάρχουν δύο ειδών map editors,
 ### Text Editor
