...
### SemA.html - SemC.html
Η λογική για την δημιουργία των πινάκων είναι ακριβώς η ιδία και στα δύο αρχεία. Αρχικά, δημιούργησα έναν πίνακα σε γλώσσα liquid, ο οποίος περιέχει με την σειρά, τις ημέρες που πραγματοποιούνται οι εξετάσεις των μαθημάτων. Για να χωριστούν με την σωστή σειρά, όταν καλείται ο πίνακας, χωρίζει τα στοιχεία του με βάση το κόμμα(,).Στην συνέχεια, χρησιμοποιώ την εντολή `table` της γλώσσας html γι να δημιουργήσω τον πίνακα. Με την εντολή `thead` εισάγω όλες τις απαιρέτητες επικεφαλίδες(ΩΡΑ,ΗΜΕΡΑ κ.α). Για την προσθήκη περιεχομένου στον πίνακα, χρησιμοποιείται η εντολή `tbody`. Μέσα σε αυτή, για την εισαγωγή των στοιχείων με την σωστή σειρά χρησιμοποιείται μια διπλή for της γλώσσας liquid
