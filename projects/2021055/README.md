...
## ΚΡΙΤΗΡΙΑ
#### Τα παρακάτω κριτήρια επιλέχθηκαν με βάση τις δυνατότητες που παρέχει η πλειοψηφία των fantasy consoles που επέλεξα προσωπικά για μελέτη.
 ### Sound Editor
 Ο sound editor επιτρέπει στον χρήστη
