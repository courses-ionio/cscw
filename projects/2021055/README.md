...
Στο ατομικό κομμάτι της εβδομαδιαίας δραστηριότητας, δημιούργησα το προσωπικό μου [site](https://axileaszervos.netlify.app/) και έφτιαξα 2 εικόνες, μία για το [Cisco Webex](https://www.cisco.com/c/en/us/products/conferencing/webex.html) και μία για το [Edmodo](https://seminars.etwinning.gr/mod/page/view.php?id=33221). Η επιλογή των εικόνων βασίστηκε, στην συνέχεια της έρευνας μου για την εκπαιδευτική τεχνολογία. Πιο συγκεκριμένα, στο προηγούμενο εξάμηνο, εμβάθυνα σε συστήματα διάδρασης που απευθυνόντουσαν σε μικρές ηλικίες. Σε αυτό το μάθημα, στόχος αποτελεί η έρευνα σε συνεργατικά συστήματα εκπαίδευσης.
